...
```{r }
test_r <- try(suppressWarnings(rast(system.file("extdata", "ERA5land_mth_Nouragues_2021_2022.nc", package = "rcontroll"))))

if (inherits(test_r,"try-error")) {
  test_r <- try(suppressWarnings(rast( "../inst/extdata/ERA5land_mth_Nouragues_2021_2022.nc")))
}
