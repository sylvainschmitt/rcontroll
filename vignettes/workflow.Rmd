...
```{r datasim}
TROLLv3_species <- read.csv("~/Documents/v3/TROLLv3_species_NP.txt", sep="")
TROLLv3_climatedaytime12 <- read.delim("~/Documents/v3/TROLLv3_climatedaytime12.txt", header=TRUE)
data("TROLLv3_climatedaytime365")
data("TROLLv3_daytimevar")
TROLLv3_input <- generate_parameters(cols = 250, rows = 250)
...
TROLLv3_input$value[6] <- 12 # Nb iterations per Year
TROLLv3_input$value[5] <- Nyears*12 # iterations
sim2 <- troll(name="Long_term_simulation_t10-5_21-10-21",
             overwrite = TRUE,
             full = FALSE,
             abc = FALSE, 
             random = TRUE,
...
sim_STK1 <- stack(name = "test3", 
             ...
             species = TROLLv3_species,
             climate = TROLLv3_climatedaytime12,
             daily = TROLLv3_daytimevar,cores = 2)
sim_STK1
```
...
```{r fullstackG2}
autoplot(sim_STK1, what = "final pattern")
```

## Reduced

```{r reducedstack}
sim_STK2 <- stack(name = "test",
             simulations = c("seed50000", "seed500"),
             # path = "/home/sylvain/Documents/ECOFOG/rcontroll",
             full = FALSE,
             abc = FALSE, 
