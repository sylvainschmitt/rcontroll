...
```{r}
sim_stack <- stack(name = "teststackLid",
                   path = getwd(),
                   ...
                   lidar = list(
                     ...
                     "20pc" = generate_lidar(mean_beam_pc = 10, iter_pointcloud_generation = 1)
...
```{r}
unlink(paste0(getwd(),"/testLid"),force = TRUE)
unlink(paste0(getwd(),"/teststackLid"),force = TRUE)
```
