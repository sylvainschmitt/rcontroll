...
sim <- troll(name = "testLid",
             ...
             lidar = generate_lidar(mean_beam_pc = 10, iter_pointcloud_generation = 12),
             verbose = FALSE)
```
...
sim_stack <- stack(name = "teststack", 
                   ...
                   forest = get_forest(TROLLv3_output),
                   lidar = list(
                     "10pc" = generate_lidar(mean_beam_pc = 10, iter_pointcloud_generation = 12),
                     "20pc" = generate_lidar(mean_beam_pc = 10, iter_pointcloud_generation = 12)
