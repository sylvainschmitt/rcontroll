...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::string >::type pedology_file(pedology_fileSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type soil_file(soil_fileSEXP);
    Rcpp::traits::input_parameter< std::string >::type output_file(output_fileSEXP);
    trollCpp(global_file, climate_file, species_file, day_file, pedology_file, lidar_file, forest_file, soil_file, output_file);
    return R_NilValue;
END_RCPP
}
