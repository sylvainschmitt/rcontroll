...
// trollCpp
void trollCpp(std::string global_file, std::string climate_file, std::string species_file, std::string day_file, std::string output_file);
RcppExport SEXP _rcontroll_trollCpp(SEXP global_fileSEXP, SEXP climate_fileSEXP, SEXP species_fileSEXP, SEXP day_fileSEXP, SEXP output_fileSEXP) {
BEGIN_RCPP
    ...
    trollCpp(global_file, climate_file, species_file, day_file, output_file);
    return R_NilValue;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_rcontroll_trollCpp", (DL_FUNC) &_rcontroll_trollCpp, 5},
    {NULL, NULL, 0}
};
