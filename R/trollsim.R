...
#' @slot inputs list. Simulation inputs (species, climate, daily, pedology,
#'   forest,lidar).
#' @slot log chr. Simulation log.
#' @slot forest df. Simulation initial and final forest.
#' @slot soil df. Soil metrics.
#' @slot ecosystem df. Ecosystem metrics.
#' @slot species df. Species metrics.
...
#' @param soil df. Soil metrics.
#' @param ecosystem df. Ecosystem metrics.
#' @param species df. Species metrics.
