#' rcontroll
#'
#' controll integrates the individual-based and spatially-explicit TROLL model
...
#' conditions.
#'
#' @section Section Description: \describe{ The rcontroll package relies on a
#'   few functions in R to generate and provide inputs, prepare and run the
#'   simulations, and analyze the simulations through tables, figures, and maps
#'   that are easily connected to the rest of the R package ecosystem. The whole
...
# sticker("~/Téléchargements/TROLL.png", package="rcontroll", p_size=20, s_x=1, s_y = 0.85, s_width=.6, p_y = 1.6,
#         filename="inst/figures/logo.png", h_color = "darkblue", h_fill = "white", p_color = "black")
